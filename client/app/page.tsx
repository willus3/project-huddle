...
import A3Canvas from "./components/A3Canvas";
...
export default function Home() {
  ...
  const [activeA3Idea, setActiveA3Idea] = useState<any>(null);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 w-full md:w-auto">
          ...
          <div className="flex bg-gray-100 dark:bg-gray-700 p-1 rounded-lg w-full md:w-auto overflow-x-auto">
            <div className="flex flex-nowrap min-w-max">
              ...
              <button onClick={() => setActiveTab("company")} className={`px-3 py-2 rounded-md text-xs md:text-sm font-medium transition-all ${activeTab === 'company' ? 'bg-white dark:bg-gray-600 text-gray-900 dark:text-white shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white'}`}>Company Overview</button>
      ...
      <div className="max-w-[1400px] mx-auto p-4 md:p-8">
        ...
        {activeTab === "huddle" && (
          <div>
            <div className="bg-slate-700 dark:bg-slate-800 text-white border-2 border-slate-600 dark:border-slate-700 p-6 rounded-xl shadow-md mb-8">
            ...
            <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-4">Execution Tracking</h2>
            <KanbanBoard ideas={ideas.filter(i => !i.is_archived)} onUpdate={updateIdea} isManager={currentUser.role === 'manager'} onIdeaClick={setSelectedIdea} isPro={isPro} onA3Click={setActiveA3Idea} />
