...
const QUADRANTS = [
  { id: 'q1', label: '💎 Quick Wins (High Impact, Low Effort)', bg: 'bg-blue-50 dark:bg-blue-900/20', border: 'border-blue-200 dark:border-blue-800', text: 'text-blue-700 dark:text-blue-200', impact: 'High', effort: 'Low' },
  { id: 'q2', label: '🏆 Major Projects (High Impact, High Effort)', bg: 'bg-indigo-50 dark:bg-indigo-900/20', border: 'border-indigo-200 dark:border-indigo-800', text: 'text-indigo-700 dark:text-indigo-200', impact: 'High', effort: 'High' },
  { id: 'q3', label: '🔧 Incremental (Low Impact, Low Effort)', bg: 'bg-slate-50 dark:bg-slate-800', border: 'border-slate-200 dark:border-slate-700', text: 'text-slate-700 dark:text-slate-300', impact: 'Low', effort: 'Low' },
                      ...
                      <div className="block md:hidden group-hover:block animate-in fade-in duration-200 mt-2 border-t pt-2 md:mt-0 md:border-0 md:pt-0">
                        <div className="md:border-t md:border-gray-100 md:pt-2 md:mt-2">
                          ...
                          <div className="flex flex-wrap gap-1 justify-between">
                            <button onClick={() => handlePromoteClick(idea.id, 'Quick_Win')} className="text-[10px] bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-1 rounded hover:bg-blue-200 dark:hover:bg-blue-800 flex-1 font-medium shadow-sm">⚡ Win</button>
                            <button onClick={() => handlePromoteClick(idea.id, '30_Days')} className="text-[10px] bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 px-2 py-1 rounded hover:bg-indigo-200 dark:hover:bg-indigo-800 flex-1 font-medium shadow-sm">📅 30d</button>
                            ...
                            <button onClick={() => handlePromoteClick(idea.id, '360_Days')} className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-2 py-1 rounded hover:bg-slate-200 dark:hover:bg-slate-700 flex-1 font-medium shadow-sm">🏗️ 1y</button>
                          </div>
                        </div>
                      </div>
                    )}
